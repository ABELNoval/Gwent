...
namespace Jujutsu_Kaisen_Game_Proyect.Assets.BackEnd
{
    ...
    public class Deck
    {
        ...
        public static List<Card> CreateSorcererDeck()
        {
            ...
            deck.Add(new ComunCard("Fushiguro", "Hechicero de primer grado de la escuela de Jujutsu en Tokio, es el portador de Las Diez Sombras, una hablidad heredada de su clan que le permite invocar varios shikigamis a voluntad", Resources.Load<Sprite>("Art/Images/Megumi"), CardPos.Range, TypeOfCard.ComunCard, "Sorcer", 6));
            deck.Add(new ComunCard("Nanami", "Hechicero de primer grado de la ecuela de JuJutsu en Tokio, es un gran profesor aunque odia el trbajo e incumplir sus horarios, es un hechicero de gran nivel cuya tecnica herradica en golpear los puntos criticos de sus oponentes", Resources.Load<Sprite>("Art/Images/Nanami"), CardPos.Melee, TypeOfCard.ComunCard, "Sorcer", 5));
            deck.Add(new ComunCard("Nanami", "Hechicero de primer grado de la ecuela de JuJutsu en Tokio, es un gran profesor aunque odia el trbajo e incumplir sus horarios, es un hechicero de gran nivel cuya tecnica herradica en golpear los puntos criticos de sus oponentes", Resources.Load<Sprite>("Art/Images/Nanami"), CardPos.Melee, TypeOfCard.ComunCard, "Sorcer", 5));
            deck.Add(new SilverCard("Yuta", "Hechicero de grado especial de la escuela de Jujutsu en Tokio, es considerado el mas fuerte despues de Satoru Gojo, es un gran prodigio con la capacidad de copiar tecnicas de otros hechiceros y posee como su shikigami personal a la llamda Reina de las Maldiciones de grado especial", Resources.Load<Sprite>("Art/Images/Yuta"), CardPos.MeleeAndSiege, TypeOfCard.SilverCard, "Sorcer", "Aumenta en 1 las cartas de la fila donde se coloca", 8, TypeOfEffects.Yuta));
            deck.Add(new SilverCard("Yuta", "Hechicero de grado especial de la escuela de Jujutsu en Tokio, es considerado el mas fuerte despues de Satoru Gojo, es un gran prodigio con la capacidad de copiar tecnicas de otros hechiceros y posee como su shikigami personal a la llamda Reina de las Maldiciones de grado especial", Resources.Load<Sprite>("Art/Images/Yuta"), CardPos.MeleeAndSiege, TypeOfCard.SilverCard, "Sorcer", "Aumenta en 1 las cartas de la fila donde se coloca", 8, TypeOfEffects.Yuta));
            deck.Add(new SilverCard("Hakari", "Hechicero de grado especial de la escuela de Jujutsu en Tokio, le gustan las apuestas y es conocido por su gran suerte y capacidad fisica", Resources.Load<Sprite>("Art/Images/Hakari"), CardPos.Melee, TypeOfCard.SilverCard, "Sorcer", "Cuando es invocado Hakari tirara un dado que, en dependencia del nurmeo que caiga este recibira ese ataque extra", 4, TypeOfEffects.Hakari));
            deck.Add(new SilverCard("Hakari", "Hechicero de grado especial de la escuela de Jujutsu en Tokio, le gustan las apuestas y es conocido por su gran suerte y capacidad fisica", Resources.Load<Sprite>("Art/Images/Hakari"), CardPos.Melee, TypeOfCard.SilverCard, "Sorcer", "Cuando es invocado Hakari tirara un dado que, en dependencia del nurmeo que caiga este recibira ese ataque extra", 4, TypeOfEffects.Hakari));
            deck.Add(new SilverCard("Higuruma", "Tiene dos meses de experiencia como hechicero y es considerado un genio debido al gran avance que consiguio en tan poco timpo. Es un abogado cansado de las injusticias de este mundo", Resources.Load<Sprite>("Art/Images/Higuruma"), CardPos.Melee, TypeOfCard.SilverCard, "Sorcer", "Eliminar la carta con menos poder del rival", 5, TypeOfEffects.Higuruma));
            deck.Add(new SilverCard("Higuruma", "Tiene dos meses de experiencia como hechicero y es considerado un genio debido al gran avance que consiguio en tan poco timpo. Es un abogado cansado de las injusticias de este mundo", Resources.Load<Sprite>("Art/Images/Higuruma"), CardPos.Melee, TypeOfCard.SilverCard, "Sorcer", "Eliminar la carta con menos poder del rival", 5, TypeOfEffects.Higuruma));
            deck.Add(new ComunCard("Toji Fushiguro", "Su trabajo radica en la caza de Hechiceros y en varias ocaciones se le ha visto enfrentarse contra maldiciones. Posee una restriccion celestial que le permite hacer frente a los pinaculos de la hechiceria sin poseer energia maldita ", Resources.Load<Sprite>("Art/Images/Toji"), CardPos.Melee, TypeOfCard.ComunCard, "Sorcer Hunter", 7));
            deck.Add(new ComunCard("Maki", "Hechicera de primera clase de la escuela de Jujutsu en Tokio. Posee una restriccion celestial que le da unas capacidades sobre humanas y posee una gran destreza con las armas malditas", Resources.Load<Sprite>("Art/Images/Maki"), CardPos.MeleeAndSiege, TypeOfCard.ComunCard, "Sorcer", 7));
            deck.Add(new ComunCard("Maki", "Hechicera de primera clase de la escuela de Jujutsu en Tokio. Posee una restriccion celestial que le da unas capacidades sobre humanas y posee una gran destreza con las armas malditas", Resources.Load<Sprite>("Art/Images/Maki"), CardPos.MeleeAndSiege, TypeOfCard.ComunCard, "Sorcer", 7));
            ...
            deck.Add(new SpecialCard("Buff de energia maldita", "Potencia la energia maldita de los hechiceros", Resources.Load<Sprite>("Art/Images/Energia Maldita(potenciador)"), CardPos.Buff, TypeOfCard.SpecialCard, "Aumenta en 2 el ataque de las tropas que se encuentren en la fila seleccionada", TypeOfEffects.Buff));
            deck.Add(new SpecialCard("Buff de energia maldita", "Potencia la energia maldita de los hechiceros", Resources.Load<Sprite>("Art/Images/Energia Maldita(potenciador)"), CardPos.Buff, TypeOfCard.SpecialCard, "Aumenta en 2 el ataque de las tropas que se encuentren en la fila seleccionada", TypeOfEffects.Buff));
            deck.Add(new SpecialCard("Buggi Buggi", "Ante los sonidos de aplausos, dos hechiceros cambian de lugar", Resources.Load<Sprite>("Art/Images/Buggi Buggi"), CardPos.MeleeAndRangeAndSiege, TypeOfCard.SpecialCard, "Cambia una carta del campo por ella misma teniendo 0 de ataque", TypeOfEffects.Lure));
        ...
        public static List<Card> CreateCurseDeck()
        {
            ...
            deck.Add(new ComunCard("Jogo", "Maldicion de grado especial. Jogo cree que las maldiciones eran los verdaderos humanos y deseaba un mundo donde los de su especie dominaran la tierra", Resources.Load<Sprite>("Art/Images/Jogo"), CardPos.RangeAndSiege, TypeOfCard.SilverCard, "Curse", 6));
            deck.Add(new GoldCard("Ryomen Sukuna", "...", Resources.Load<Sprite>("Art/Images/Ryomen Sukuna"), CardPos.MeleeAndRangeAndSiege, TypeOfCard.GoldCard, "Curse", "Caclula el promedio de poder entre todas las cartas del campo (propio o del rival). Luego iguala el poder de todas las cartas del campo(propias o del rival) a ese promedio", 10, TypeOfEffects.Sukuna));
            deck.Add(new ComunCard("Hanami", "...", Resources.Load<Sprite>("Art/Images/Hanami"), CardPos.Range, TypeOfCard.ComunCard, "Curse", 5));
            deck.Add(new ComunCard("Hanami", "...", Resources.Load<Sprite>("Art/Images/Hanami"), CardPos.Range, TypeOfCard.ComunCard, "Curse", 5));
            deck.Add(new ComunCard("Hanami", "...", Resources.Load<Sprite>("Art/Images/Hanami"), CardPos.Range, TypeOfCard.ComunCard, "Curse", 5));
            deck.Add(new ComunCard("Dagon", "...", Resources.Load<Sprite>("Art/Images/Dagon"), CardPos.Melee, TypeOfCard.ComunCard, "Curse", 5));
            deck.Add(new ComunCard("Dagon", "...", Resources.Load<Sprite>("Art/Images/Dagon"), CardPos.Melee, TypeOfCard.ComunCard, "Curse", 5));
            deck.Add(new ComunCard("Dagon", "...", Resources.Load<Sprite>("Art/Images/Dagon"), CardPos.Melee, TypeOfCard.ComunCard, "Curse", 5));
            deck.Add(new SilverCard("Kenjaku", "...", Resources.Load<Sprite>("Art/Images/Kenjaku"), CardPos.RangeAndSiege, TypeOfCard.SilverCard, "Curse", "Multiplica por n su ataque, siendo n la cantidad de cartas iguales a ella en el campo", 6, TypeOfEffects.Kenjaku));
            deck.Add(new SilverCard("Kenjaku", "...", Resources.Load<Sprite>("Art/Images/Kenjaku"), CardPos.RangeAndSiege, TypeOfCard.SilverCard, "Curse", "Multiplica por n su ataque, siendo n la cantidad de cartas iguales a ella en el campo", 6, TypeOfEffects.Kenjaku));
            deck.Add(new ComunCard("Toji Fushiguro", "Su trabajo radica en la caza de Hechiceros y en varias ocaciones se le ha visto enfrentarse contra maldiciones. Posee una restriccion celestial que le permite hacer frente a los pinaculos de la hechiceria sin poseer energia maldita ", Resources.Load<Sprite>("Art/Images/Toji"), CardPos.Melee, TypeOfCard.ComunCard, "Sorcer Hunter", 7));
            deck.Add(new SilverCard("Mahito", "...", Resources.Load<Sprite>("Art/Images/Mahito"), CardPos.MeleeAndRange, TypeOfCard.SilverCard, "Curse", "Robar una carta", 7, TypeOfEffects.Mahito));
            deck.Add(new SilverCard("Mahito", "...", Resources.Load<Sprite>("Art/Images/Mahito"), CardPos.MeleeAndRange, TypeOfCard.SilverCard, "Curse", "Robar una carta", 7, TypeOfEffects.Mahito));
            deck.Add(new ComunCard("Categoria Especial", "...", Resources.Load<Sprite>("Art/Images/Categoria Especial"), CardPos.Melee, TypeOfCard.ComunCard, "Curse", 3));
            deck.Add(new ComunCard("Categoria Especial", "...", Resources.Load<Sprite>("Art/Images/Categoria Especial"), CardPos.Melee, TypeOfCard.ComunCard, "Curse", 3));
            deck.Add(new SilverCard("Kashimo", "...", Resources.Load<Sprite>("Art/Images/Kashimo"), CardPos.Siege, TypeOfCard.SilverCard, "Curse", "Elimina la carta con mas poder de ambos jugadores", 7, TypeOfEffects.Kashimo));
            deck.Add(new SilverCard("Kashimo", "...", Resources.Load<Sprite>("Art/Images/Kashimo"), CardPos.Siege, TypeOfCard.SilverCard, "Curse", "Elimina la carta con mas poder de ambos jugadores", 7, TypeOfEffects.Kashimo));
            ...
            deck.Add(new SpecialCard("Dedo de Sukuna", "Potencia la energia maldita de las maldiciones", Resources.Load<Sprite>("Art/Images/Dedo de Sukuna(potenciador)"), CardPos.Buff, TypeOfCard.SpecialCard, "Aumenta en 2 el ataque de las cartas que se encuentren en la fila seleccionada", TypeOfEffects.Buff));
            deck.Add(new SpecialCard("Dedo de Sukuna", "Potencia la energia maldita de las maldiciones", Resources.Load<Sprite>("Art/Images/Dedo de Sukuna(potenciador)"), CardPos.Buff, TypeOfCard.SpecialCard, "Aumenta en 2 el ataque de las cartas que se encuentren en la fila seleccionada", TypeOfEffects.Buff));
            deck.Add(new SpecialCard("Cambio de forma", "La forma de una tropa cambia a la de otra, habia sido una alteracion de Mahito todo el tiempo", Resources.Load<Sprite>("Art/Images/Buggi Buggi"), CardPos.MeleeAndRangeAndSiege, TypeOfCard.SpecialCard, "Cambia una carta de la mano por una del campo", TypeOfEffects.Lure));
